...
<body>
  ...
  <div class="container ">
    <h1 class="display-4 text-center">Journals</h1>
    <li class="lead text-center">Bienvenue sur la page des Journals  <strong> <?= $_SESSION['nom'] ?></strong> !</li>
  </div>
   </div>
      <div class="row ">
        <div class="col-lg-12 ">
         <div class="card w-100 shadow-lg mb-2">
          <div class="card-title pl-5">
            <div class="card-body">
            <ol>
            <li> <h5>Journals des Achats</h5></li>
            <ol>
                <li><a style='color:black;' href="visteurs.php?page=journal_achats&id=<?=$_SESSION['id'] ?>">Journals des Achats de Marchandises</a></li>
                <li><a style='color:black;' href="visteurs.php?page=journal_achat_immobilisation&id=<?=$_SESSION['id'] ?>">Journals des Achats de Materièls</a></li>
            </ol>
            <li> <h5>Journals des Ventes</h5></li>
            <ol>
                <li>Journals des Ventes de Marchandises</li>
                <li>Journals des Ventes de Materièls</li>
            </ol>
            <li> <a href=""><h5>Journals Produits</h5></a></li>
            <li> <a href=""><h5>Journals Charges</h5></a></li>
            <li> <a href=""><h5> Journals Comptabilités des Societes</h5></a></li>
            </ol>
          </div>
         </div>
        </div>
