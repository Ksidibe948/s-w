...
<a style='; color:#A41FDE' class="nav-link pl-3 " href="#"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
 ...
 Factures de autre charges <span style='color:green'>( <?=$autres_charges?>)</span> 
  ...
  <a  class="nav-link pl-2 " style="font-size:1.2rem; "  href="visteurs.php?page=facturesventes&id=<?=$_SESSION['id'] ?>">              
<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M14.5 3h-13a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-13z"/>
  <path fill-rule="evenodd" d="M5 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 5 8zm0-2.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm0 5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5z"/>
  <circle cx="3.5" cy="5.5" r=".5"/>
...
<!-- la partie inscription -->
                            ...
                            <div class="card-body">
                               <hr> <h1 class="card-title text-center">
                                Modification du compte de la <?=  $element_banque['nom_banque'] ?>
                                </h1><hr>
                                <div class="row">
                              ...
                              <label for="inputPassword" class="col-lg-12 col-form-label">Nom de la banque</label>
                              <div class="col-lg-12">
                            ...
                            <div class="form-group row">
                              ...
                              <label for="inputPassword" class="col-lg-12 col-form-label">Adresse de la Banque</label>
                              <div class="col-lg-12">
                            ...
                            <div class="form-group row">
                              ...
                              <label for="inputPassword" class="col-lg-12 col-form-label">Numéro de la banque</label>
                              <div class="col-lg-12">
                            ...
                            <label for="inputPassword" class="col-lg-12 col-form-label">Email de la banque</label>
                            <div class="col-lg-12">
                            ...
                            <div class="form-group row">
                              ...
                              <label for="inputPassword" class="col-lg-12 col-form-label">Photo de la banque</label>
                              <div class="col-lg-12">
                            ...
                            <div class="form-group row">
                              ...
                              <label for="inputPassword" class="col-lg-12 col-form-label">Montant de depôt</label>
                              <div class="col-lg-12">
                            ...
                            <div class="form-group row">
                              ...
                              <label for="inputPassword" class="col-lg-12 col-form-label">Frais des opérations </label>
                              <div class="col-lg-12">
                            ...
                            <div class="form-group row">
                              ...
                              <label for="inputPassword" class="col-lg-12 col-form-label">TVA bancaire </label>
                              <div class="col-lg-12">
