...
<div class="row">
  ...
  <hr>
  <a  class="nav-link pl-2 "  style="font-size:1.2rem;color:#A41FDE" href="visteurs.php?page=produits&id=<?=$_SESSION['id'] ?>"> 
 ...
 <div class="col-lg-12 ">         
   <div class="row mt-5">
    <div class="col-lg-4 mt-5">
        <div class="card w-100 mt-5 shadow-lg bg-light"  >  
        <div class="card-title text-center pt-5">
        <a  class="nav-link text-secondary "  href="visteurs.php?page=produits_exploitation&id=<?=$_SESSION['id'] ?>">              
          <p style='  font-size:1.5rem'>Produits exploitations</p>
    ...
    <div class="col-lg-4 mt-5 ">
        <div class="card w-100 mt-5 shadow-lg bg-light"  >
        <div class="card-title text-center pt-5">
        <a  class="nav-link text-secondary"  href="visteurs.php?page=produits_financiers&id=<?=$_SESSION['id'] ?>"> 
          <p style='  font-size:1.5rem'>Produits Financiers</p>
          <svg width="5em" height="5em" viewBox="0 0 16 16" class="bi bi-fullscreen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" d="M1.5 1a.5.5 0 0 0-.5.5v4a.5.5 0 0 1-1 0v-4A1.5 1.5 0 0 1 1.5 0h4a.5.5 0 0 1 0 1h-4zM10 .5a.5.5 0 0 1 .5-.5h4A1.5 1.5 0 0 1 16 1.5v4a.5.5 0 0 1-1 0v-4a.5.5 0 0 0-.5-.5h-4a.5.5 0 0 1-.5-.5zM.5 10a.5.5 0 0 1 .5.5v4a.5.5 0 0 0 .5.5h4a.5.5 0 0 1 0 1h-4A1.5 1.5 0 0 1 0 14.5v-4a.5.5 0 0 1 .5-.5zm15 0a.5.5 0 0 1 .5.5v4a1.5 1.5 0 0 1-1.5 1.5h-4a.5.5 0 0 1 0-1h4a.5.5 0 0 0 .5-.5v-4a.5.5 0 0 1 .5-.5z"/>
          </svg>
          </a> 
    ...
    <div class="col-lg-4 mt-5 ">
        <div class="card w-100 mt-5 shadow-lg bg-light"  >
        <div class="card-title text-center pt-5">
        <a  class="nav-link text-secondary"  href="visteurs.php?page=produits_execeptionnels&id=<?=$_SESSION['id'] ?>"> 
          <p style='  font-size:1.5rem'>Produits exceptionnel</p>
          <svg width="5em" height="5em" viewBox="0 0 16 16" class="bi bi-fullscreen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" d="M1.5 1a.5.5 0 0 0-.5.5v4a.5.5 0 0 1-1 0v-4A1.5 1.5 0 0 1 1.5 0h4a.5.5 0 0 1 0 1h-4zM10 .5a.5.5 0 0 1 .5-.5h4A1.5 1.5 0 0 1 16 1.5v4a.5.5 0 0 1-1 0v-4a.5.5 0 0 0-.5-.5h-4a.5.5 0 0 1-.5-.5zM.5 10a.5.5 0 0 1 .5.5v4a.5.5 0 0 0 .5.5h4a.5.5 0 0 1 0 1h-4A1.5 1.5 0 0 1 0 14.5v-4a.5.5 0 0 1 .5-.5zm15 0a.5.5 0 0 1 .5.5v4a1.5 1.5 0 0 1-1.5 1.5h-4a.5.5 0 0 1 0-1h4a.5.5 0 0 0 .5-.5v-4a.5.5 0 0 1 .5-.5z"/>
          </svg>
          </a> 
