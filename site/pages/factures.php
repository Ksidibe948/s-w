...
<?php
$bdd=new PDO('mysql:host=localhost; dbname=w&k;charset=utf8','root','');
   $actionnaires=$bdd->query('SELECT * FROM actionnaires ORDER BY id DESC');
   $actionnaire=$actionnaires->rowcount();
   ...
   <?php
$bdd=new PDO('mysql:host=localhost; dbname=w&k;charset=utf8','root','');
   $stocks_marchandises=$bdd->query('SELECT * FROM achats ORDER BY id DESC');
   $stok_marchandise=$stocks_marchandises->rowcount();

   ?>
     <?php
$bdd=new PDO('mysql:host=localhost; dbname=w&k;charset=utf8','root','');
   $stocks_marteriels=$bdd->query('SELECT * FROM achats_immobilisation ORDER BY id DESC');
...
<a  class="nav-link  " style="font-size:1.3rem;   color:#A41FDE"  href="visteurs.php?page=factures&id=<?=$_SESSION['id'] ?>">              
...
<div class="col-lg-9 ">         
 <div class="row mt-5 ">
        ...
        <div class="col-lg-6 ">
        <a class="nav-link " style=' color:black' href="visteurs.php?page=facturesachats&id=<?=$_SESSION['id'] ?>">
         <div class="card w-100  shadow-lg bg-white p-2 "  >
         <div class="card-title  text-center text-primary pt-2">
          <h4>Factures d'Achats</h4>
          <svg width="10em" height="10em" viewBox="0 0 16 16" class="bi  imagess bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          <path fill-rule="evenodd" d="M14.5 3h-13a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-13z"/>
          <path fill-rule="evenodd" d="M5 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 5 8zm0-2.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm0 5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5z"/>
          <circle cx="3.5" cy="5.5" r=".5"/>
          <circle cx="3.5" cy="8" r=".5"/>
        ...
        <div class="col-lg-6 ">
        <a  class="nav-link " href="visteurs.php?page=facturesventes&id=<?=$_SESSION['id'] ?>">
         <div class="card w-100 shadow-lg bg-white p-2   " >
        ...
        <div class="col-lg-6 ">
        <a class="nav-link "  href="visteurs.php?page=factureautreentreargent&id=<?=$_SESSION['id'] ?>">
         <div class="card w-100 shadow-lg bg-white p-2  " >
         <div class="card-title text-center   text-info  pt-2">
           <h4>Factures de Autre Produits</h4>
           <svg width="10em" height="10em" viewBox="0 0 16 16" class="bi  imagess bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          <path fill-rule="evenodd" d="M14.5 3h-13a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-13z"/>
          <path fill-rule="evenodd" d="M5 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 5 8zm0-2.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm0 5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5z"/>
          <circle cx="3.5" cy="5.5" r=".5"/>
        ...
        <div class="col-lg-6 ">
        <a class="nav-link "style=' color:black' href="visteurs.php?page=factureautresortieargent&id=<?=$_SESSION['id'] ?>">
         <div class="card w-100   shadow-lg bg-white ">
         <div class="card-title  text-center text-success  p-2  pt-2">
           <h4>Facture de Autres Charges</h4>
           <svg width="10em" height="10em" viewBox="0 0 16 16" class="bi  imagess bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          <path fill-rule="evenodd" d="M14.5 3h-13a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-13z"/>
          <path fill-rule="evenodd" d="M5 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 5 8zm0-2.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm0 5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5z"/>
          <circle cx="3.5" cy="5.5" r=".5"/>
