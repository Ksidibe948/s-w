...
<?php
  ...
  <path fill-rule="evenodd" d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
   ...
   <a style='font-size:1.1rem;color:#A41FDE' class="nav-link "  href="visteurs.php?page=nouveau_actionnaire&id=<?=$_SESSION['id'] ?>">
               <svg width="1.1em" height="1.1em" viewBox="0 0 16 16" class="bi bi-plus" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
               <path fill-rule="evenodd" d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
               </svg>
               Création d'un nouveau compte  actionnaire
   </a>    
  <hr>
       ...
       <div class="col-lg-9">
                            ...
                            <div class="card-body">
                              ...
                              <label for="inputZip">Montant souscrit</label>
                                <input type="number"  name='montant_souscrit'class="form-control " id="inputCity" required placeholder="EX: 200 000">
                              </div>
                              </div>
