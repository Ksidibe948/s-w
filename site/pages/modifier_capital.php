...
<?php
  ...
  <?php
   ...
   Capital   <span style='color:green'> ( <?= $capital['capital'] ?> dh) actions (<?= $capital['actions'] ?>)</span>
    ...
    <a  class="nav-link  "  style='margin-left:15px ;color:#A41FDE' href="#"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
         ...
         <div class="row">
           <div class="col-lg-9">
                            ...
                            <div class="form-group row">
                              ...
                              <label for="inputPassword" class="col-12 col-form-label">Montant du Capital </label>
                              <div class="col-12">
                            ...
                            <div class="form-group row">
                              ...
                              <label for="inputPassword" class="col-12 col-form-label">Nombre d'action </label>
                              <div class="col-12">
