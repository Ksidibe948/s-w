...
<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
 ...
 Factures Achats de matiere première <span style='color:green'> ( <?=$stok_marchandise?> )</span>
  </a>
  <a style='font-size:1.1rem ;color:#A41FDE' class="nav-link  "  href="visteurs.php?page=nouvelle_facture_achat&id=<?=$_SESSION['id'] ?>">
  <svg width="1.1em" height="1.1em" viewBox="0 0 16 16" class="bi bi-plus" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path fill-rule="evenodd" d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
  </svg>
     Etablissements nouvelle <br> facture achats premiere
  </a>
  <hr>
...
<div class="container">
  <div class="col-lg-9">
                            ...
                            <div class="card-body">
                              ...
                              <label for="inputPassword" class="col-sm-3 col-form-label">Fournisseurs :  </label>
                              <div class="col-sm-3">
