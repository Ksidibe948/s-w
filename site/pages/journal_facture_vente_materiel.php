...
<?php
   $bdd=new PDO('mysql:host=localhost; dbname=w&k;charset=utf8','root','');
   $vnt_marteriels=$bdd->prepare('SELECT 
    id_client,
        id_entreprise,
        marchandise,
        quantite,
   ...
   FROM vente_materiels WHERE id_entreprise=? ORDER BY id DESC ');
   $vnt_marteriels->execute(array($_SESSION['id']));
   ?>
...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbar">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item  mr-3">
              <a class="nav-link" href="visteurs.php?page=journal_achats">Factures Materiel<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item active  mr-3">
              <a class="nav-link" href=""> Journal vente materiel <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item mr-3">
    ...
    <?php
     ...
     while($donnees=$vnt_marteriels->fetch())
     {
         ...
         ?>
          <div class="container ">
            <div class="row mb-4">
                ...
                <a style='color:black;   text-decoration: none;' href="visteurs.php?page=journal_chaquevente_materiel&id=<?=$donnees['id'] ?>">
