...
<?php
   $bdd=new PDO('mysql:host=localhost; dbname=w&k;charset=utf8','root','');
   $achat_imo=$bdd->prepare('SELECT * FROM achats_immobilisation WHERE id=? ORDER BY id DESC ');
   $achat_imo->execute(array($getid));
   ?>
        ...
        <div class="collapse navbar-collapse" id="navbar">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item  mr-3">
              <a class="nav-link" href="visteurs.php?page=journal_achat_immobilisation">Journals<span class="sr-only">(current)</span></a>
            </li>
