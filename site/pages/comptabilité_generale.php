...
<div class="row">
  ...
  <div class="overflow-auto" style='width:100%;
    height:1000px;'>
     ...
     <a  class="nav-link " style="font-size:1.2rem; color:#A41FDE " href="visteurs.php?page=comptabilité_generale&id=<?=$_SESSION['id'] ?>">
 ...
 <?php
  ...
  <path d="M11 5.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1-.5-.5v-1zM1 9h14v2H1V9z"/>
   ...
   ?> (<?= $banque['nom_banque'] ?> <span style='color:green'> <?= $banque['montant'] ?> dh)</span> <br> 
   <?php
 }
   }
   ?>
...
<path fill-rule="evenodd" d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
 ...
 Actionnaire <?php
   ...
   ?><span style='color:green'>( <?= $actionnaire['nom'] ?> <?= $actionnaire['prenom'] ?>)</span><br>
...
<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
 ...
 Factures Achats de Marchandises 
 <?php
...
<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
 ...
 Factures de autre charges  <?php
   if ($autres_charges>0) {
     ?> <span style='color:green'>(<?=$autres_charges?>)</span> 
     <?php
   } else {
     echo '(0)';
   }?>
  ...
  <a  class="nav-link pl-2 " style="font-size:1rem; "  href="visteurs.php?page=facturesventes&id=<?=$_SESSION['id'] ?>">              
<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M14.5 3h-13a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-13z"/>
  <path fill-rule="evenodd" d="M5 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 5 8zm0-2.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm0 5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5z"/>
  <circle cx="3.5" cy="5.5" r=".5"/>
 ...
 Factures Ventes de materiels 
  <?php
      if ($vente_materiels>0) {
        ?> <span style='color:green'> (<?=$vente_materiels?>)</span>
  </a><hr>
 ...
 <div class="col-lg-12 ">         
   <div class="row ">
    <div class="col-lg-3 mt-3 ">
        ...
        <a  class="nav-link text-info" href="visteurs.php?page=banque&id=<?=$_SESSION['id'] ?>">
         <p style='  font-size:1.5rem'>Banque <br>
        </p>
        <svg width="5em" height="5em"  viewBox="0 0 16 16" class="bi  bi-credit-card-2-back" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" d="M14 3H2a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1zM2 2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H2z"/>
        <path d="M11 5.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1-.5-.5v-1zM1 9h14v2H1V9z"/>
       </svg><br>
       (  <?= $bq?> )
    ...
    <div class="col-lg-3 mt-3 ">
        <div class="card w-100 shadow-lg  bg-light"  >
        <div class="card-title text-center pt-5">
        <a  class="nav-link text-info " href="visteurs.php?page=capital&id=<?=$_SESSION['id'] ?>">
          <p style='  font-size:1.5rem'>Capital </p>
          <svg width="5em" height="5em" viewBox="0 0 16 16" class="bi bi-cash-stack" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          <path d="M14 3H1a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1h-1z"/>
          <path fill-rule="evenodd" d="M15 5H1v8h14V5zM1 4a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1H1z"/>
          <path d="M13 5a2 2 0 0 0 2 2V5h-2zM3 5a2 2 0 0 1-2 2V5h2zm10 8a2 2 0 0 1 2-2v2h-2zM3 13a2 2 0 0 0-2-2v2h2zm7-4a2 2 0 1 1-4 0 2 2 0 0 1 4 0z"/>
        </svg><br>
 ...
 if ($capital['capital'] >0) 
 {
   ?>
    ...
    <div class="col-lg-3 mt-3 ">
        <div class="card w-100 shadow-lg bg-light"  >
        <div class="card-title text-center pt-5">
        <a  class="nav-link  text-info " href="visteurs.php?page=actionnaires&id=<?=$_SESSION['id'] ?>">
          <p style='  font-size:1.5rem'>Actionnaires </p>
   ...
   <?php
    ...
    <div class="col-lg-3 mt-3 ">
        <div class="card w-100 shadow-lg bg-light"  >  
        <div class="card-title text-center pt-5">
        <a  class="nav-link text-info "  href="visteurs.php?page=clients&id=<?=$_SESSION['id'] ?>">              
    ...
    <div class="col-lg-3 mt-3 ">
        <div class="card w-100 shadow-lg bg-light"  >  
        <div class="card-title text-center pt-5">
        <a  class="nav-link text-secondary "  href="visteurs.php?page=fournisseurs&id=<?=$_SESSION['id'] ?>">              
          <p style='  font-size:1.5rem'>Fournisseurs </p>
          <svg width="5em" height="5em" viewBox="0 0 16 16" class="bi bi-people" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" d="M15 14s1 0 1-1-1-4-5-4-5 3-5 4 1 1 1 1h8zm-7.978-1h7.956a.274.274 0 0 0 .014-.002l.008-.002c-.002-.264-.167-1.03-.76-1.72C13.688 10.629 12.718 10 11 10c-1.717 0-2.687.63-3.24 1.276-.593.69-.759 1.457-.76 1.72a1.05 1.05 0 0 0 .022.004zM11 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm3-2a3 3 0 1 1-6 0 3 3 0 0 1 6 0zM6.936 9.28a5.88 5.88 0 0 0-1.23-.247A7.35 7.35 0 0 0 5 9c-4 0-5 3-5 4 0 .667.333 1 1 1h4.216A2.238 2.238 0 0 1 5 13c0-1.01.377-2.042 1.09-2.904.243-.294.526-.569.846-.816zM4.92 10c-1.668.02-2.615.64-3.16 1.276C1.163 11.97 1 12.739 1 13h3c0-1.045.323-2.086.92-3zM1.5 5.5a3 3 0 1 1 6 0 3 3 0 0 1-6 0zm3-2a2 2 0 1 0 0 4 2 2 0 0 0 0-4z"/>
          </svg><br>
          (<?= $fournisseurs?>)
    ...
    <div class="col-lg-3 mt-3 ">
        <div class="card w-100 shadow-lg bg-light"  >  
        <div class="card-title text-center pt-5">
        <a  class="nav-link text-secondary "  href="visteurs.php?page=factures&id=<?=$_SESSION['id'] ?>">              
          <p style='  font-size:1.5rem'>Factures</p>
          <svg width="5em" height="5em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          <path fill-rule="evenodd" d="M14.5 3h-13a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-13z"/>
          <path fill-rule="evenodd" d="M5 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 5 8zm0-2.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm0 5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5z"/>
          <circle cx="3.5" cy="5.5" r=".5"/>
          <circle cx="3.5" cy="8" r=".5"/>
    ...
    <div class="col-lg-3 mt-3  ">
        <div class="card w-100 shadow-lg bg-light"  >
        <div class="card-title text-center pt-5">
        <a  class="nav-link text-secondary"  href="visteurs.php?page=produits&id=<?=$_SESSION['id'] ?>"> 
          <p style='  font-size:1.5rem'>Produits</p>
          <svg width="5em" height="5em" viewBox="0 0 16 16" class="bi bi-fullscreen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" d="M1.5 1a.5.5 0 0 0-.5.5v4a.5.5 0 0 1-1 0v-4A1.5 1.5 0 0 1 1.5 0h4a.5.5 0 0 1 0 1h-4zM10 .5a.5.5 0 0 1 .5-.5h4A1.5 1.5 0 0 1 16 1.5v4a.5.5 0 0 1-1 0v-4a.5.5 0 0 0-.5-.5h-4a.5.5 0 0 1-.5-.5zM.5 10a.5.5 0 0 1 .5.5v4a.5.5 0 0 0 .5.5h4a.5.5 0 0 1 0 1h-4A1.5 1.5 0 0 1 0 14.5v-4a.5.5 0 0 1 .5-.5zm15 0a.5.5 0 0 1 .5.5v4a1.5 1.5 0 0 1-1.5 1.5h-4a.5.5 0 0 1 0-1h4a.5.5 0 0 0 .5-.5v-4a.5.5 0 0 1 .5-.5z"/>
          </svg>
          </a> 
        </div>
    ...
    <div class="col-lg-3 mt-3  ">
        <div class="card w-100 shadow-lg bg-light"  >
        <div class="card-title text-center pt-5">
        <a  class="nav-link text-secondary"  href="visteurs.php?page=charges&id=<?=$_SESSION['id'] ?>"> 
          <p style='  font-size:1.5rem'>Charges</p>
          <svg width="5em" height="5em" viewBox="0 0 16 16" class="bi bi-fullscreen-exit" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          <path fill-rule="evenodd" d="M5.5 0a.5.5 0 0 1 .5.5v4A1.5 1.5 0 0 1 4.5 6h-4a.5.5 0 0 1 0-1h4a.5.5 0 0 0 .5-.5v-4a.5.5 0 0 1 .5-.5zm5 0a.5.5 0 0 1 .5.5v4a.5.5 0 0 0 .5.5h4a.5.5 0 0 1 0 1h-4A1.5 1.5 0 0 1 10 4.5v-4a.5.5 0 0 1 .5-.5zM0 10.5a.5.5 0 0 1 .5-.5h4A1.5 1.5 0 0 1 6 11.5v4a.5.5 0 0 1-1 0v-4a.5.5 0 0 0-.5-.5h-4a.5.5 0 0 1-.5-.5zm10 1a1.5 1.5 0 0 1 1.5-1.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 0-.5.5v4a.5.5 0 0 1-1 0v-4z"/>
        </svg>
          </a> 
        </div>
    ...
    <div class="col-lg-3 mt-3  ">
        <div class="card w-100 shadow-lg bg-light"  >
        <div class="card-title text-center pt-5">
        <a  class="nav-link text-success"  href="visteurs.php?page=journal&id=<?=$_SESSION['id'] ?>"> 
          <p style='  font-size:1.5rem'>Journal</p>
          <svg width="5em" height="5em" viewBox="0 0 16 16" class="bi bi-file-text" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          <path fill-rule="evenodd" d="M4 0h8a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2zm0 1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H4z"/>
          <path fill-rule="evenodd" d="M4.5 10.5A.5.5 0 0 1 5 10h3a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5zm0-2A.5.5 0 0 1 5 8h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5zm0-2A.5.5 0 0 1 5 6h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5zm0-2A.5.5 0 0 1 5 4h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5z"/>
          </svg>
          </a> 
 ...
 if ($stok_materiel >0) 
 {
   ?>
       <div class="col-lg-3 mt-3  ">
        <div class="card w-100 shadow-lg bg-light"  >
        <div class="card-title text-center pt-5">
        <a  class="nav-link text-success "  href="visteurs.php?page=Stocks&id=<?=$_SESSION['id'] ?>"> 
        <p style='  font-size:1.5rem'> Stocks</p>
    ...
    <div class="col-lg-3 mt-3  ">
        <div class="card w-100 shadow-lg bg-light"  >
        <div class="card-title text-center pt-5">
        <a  class="nav-link text-success "href="visteurs.php?page=amortissement&id=<?=$_SESSION['id'] ?>"> 
        <p style='  font-size:1.5rem'>Amortissements <br> (<?= $stok_materiel?>)</p>
   ...
   <?php
    ...
    <div class="col-lg-3 mt-3  ">
        <div class="card w-100 shadow-lg bg-light"  >
        <div class="card-title text-center pt-5">
        <a  class="nav-link text-success"  href="visteurs.php?page=balance&id=<?=$_SESSION['id'] ?>">
        <p style='  font-size:1.5rem'>Balances</p>
    <svg width="5em" height="5em" viewBox="0 0 16 16" class="bi bi-hourglass-split" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
     <path fill-rule="evenodd" d="M2.5 15a.5.5 0 1 1 0-1h1v-1a4.5 4.5 0 0 1 2.557-4.06c.29-.139.443-.377.443-.59v-.7c0-.213-.154-.451-.443-.59A4.5 4.5 0 0 1 3.5 3V2h-1a.5.5 0 0 1 0-1h11a.5.5 0 0 1 0 1h-1v1a4.5 4.5 0 0 1-2.557 4.06c-.29.139-.443.377-.443.59v.7c0 .213.154.451.443.59A4.5 4.5 0 0 1 12.5 13v1h1a.5.5 0 0 1 0 1h-11zm2-13v1c0 .537.12 1.045.337 1.5h6.326c.216-.455.337-.963.337-1.5V2h-7zm3 6.35c0 .701-.478 1.236-1.011 1.492A3.5 3.5 0 0 0 4.5 13s.866-1.299 3-1.48V8.35zm1 0c0 .701.478 1.236 1.011 1.492A3.5 3.5 0 0 1 11.5 13s-.866-1.299-3-1.48V8.35z"/>
    </svg>
     </a>
     </div>
  ...
  <div class="col-lg-3 mt-3  ">
        <div class="card w-100 shadow-lg bg-light"  >
        <div class="card-title text-center pt-5">
        <a  class="nav-link text-primary" href="visteurs.php?page=Bilan&id=<?=$_SESSION['id'] ?>">
        <p style='  font-size:1.5rem'>Bilan</p>
       <svg width="5em" height="5em" viewBox="0 0 16 16" class="bi bi-calendar" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
       <path fill-rule="evenodd" d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5zM1 4v10a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V4H1z"/>
      </svg>
     </a>
     </div>
  ...
  <div class="col-lg-3 mt-3  ">
        <div class="card w-100 shadow-lg bg-light"  >
        <div class="card-title text-center pt-5">
        <a  class="nav-link text-primary "  href="visteurs.php?page=cpc&id=<?=$_SESSION['id'] ?>"> 
        <p style='  font-size:1.5rem'> CPC</p>
        <svg width="5em" height="5em" viewBox="0 0 16 16" class="bi bi-file-text" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          <path fill-rule="evenodd" d="M4 0h8a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2zm0 1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H4z"/>
          <path fill-rule="evenodd" d="M4.5 10.5A.5.5 0 0 1 5 10h3a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5zm0-2A.5.5 0 0 1 5 8h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5zm0-2A.5.5 0 0 1 5 6h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5zm0-2A.5.5 0 0 1 5 4h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5z"/>
        </svg>
