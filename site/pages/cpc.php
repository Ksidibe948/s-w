...
<div class="col-lg-8 mt-5 col-12">
      <div class="row">
      <div class="col-lg-12">
       <div class="card shadow-lg mt-5 p-4 w-100">
          <div class="row ">
    ...
    <div class="row ">
              ...
              <h5>Total produits d'exploitation</h5>
              </div>
              <div class="col-4 pt-2 text-right"style='border:solid 0.5px gray'>
               <h5>.....</h5>
              </div>
    ...
    ?>
     <div class="row ">
              <div class="col-8 pt-2 text-left"style='border:solid 0.5px gray'>
              <h5>Total produits Financiers</h5>
              </div>
              <div class="col-4 pt-2 text-right"style='border:solid 0.5px gray'>
               <h5>......</h5>
              </div>
    ...
    ?>
      <div class="row ">
              <div class="col-8 pt-2 text-left"style='border:solid 0.5px gray'>
              <h5>Total de produits exceptionnels</h5>
              </div>
              <div class="col-4 pt-2 text-right"style='border:solid 0.5px gray'>
               <h5>.....</h5>
              </div>
