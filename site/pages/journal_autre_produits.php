        ...
        <div class="collapse navbar-collapse" id="navbar">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item  mr-3">
              <a class="nav-link" href="visteurs.php?page=autres_produits">Journals<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item active  mr-3">
              <a class="nav-link" href=""> Journals <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item mr-3">
     ...
     while($donnees=$select->fetch())
     {
          ...
          <div class="container ">
            <div class="row mb-4">
              <div class="col-12">
                ...
                <div class="row">
                <div class="col-12 ">
                <h5 class="display-4">Journal de <?= $donnees['nom_operation'] ?></h5>
                <?= $donnees['date'] ?>
                </div>
        ...
        <?php
          ...
          ?>
                ...
                <div class="col-2 " style='border:solid black 1px'><?= $donnees['montant_payer'] ?>
                </div>
                <div class="col-2 " style='border:solid black 1px'></div>
              </div>
                <?php
                      if ($reste<0) {
                        ...
                        <div class="col-2 " style='border:solid black 1px'><?=$reste ?>
                        </div>
                        <div class="col-2 " style='border:solid black 1px'></div>
                      </div>
                      <?php
              ...
              <div class="row ">
                <div class="col-2 " style='border:solid black 1px'></div>
                <div class="col-2" style='border:solid black 1px'>7...</div>
                <div class="col-4 " style='border:solid black 1px'>
