...
<div class="row">
 ...
 <a style="font-size:1.2rem; color:#A41FDE" class="nav-link  " href="visteurs.php?page=banque&id=<?=$_SESSION['id'] ?>">
 <?php
    ...
    <div class="col-lg-12 mt-3 ">
     ...
     <?php
        ...
        while($resultat=$select->fetch())
        {
            ?>
            <div class="col-6 ">
            <a class="nav-link " href="visteurs.php?page=detail_banque&id=<?=$resultat['id'] ?>">
             <div class="card w-100 shadow-lg  bg-white p-3 " >
                <div class='imagess'>
