...
<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
 ...
 Factures Ventes de materiels <span style='color:green'> ( <?=$vente_materiels?>)</span>
  ...
  ?>
  <a  class="nav-link   " style="font-size:1.1rem;color:#A41FDE "  href="visteurs.php?page=vente_marchandise&id=<?=$_SESSION['id'] ?>">              
<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M14.5 3h-13a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-13z"/>
  <path fill-rule="evenodd" d="M5 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 5 8zm0-2.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm0 5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5z"/>
  <circle cx="3.5" cy="5.5" r=".5"/>
 ...
 Factures Ventes de marchandises <span style='color:green'>(<?= $vente_marchandise?>)</span> 
  ...
  <a style=' font-size:1.1rem;;' class="nav-link text-success  " href="visteurs.php?page=modifier_facture_vente_marchandise&id=<?=$donnees['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
             ...
             <a style='font-size:1.2rem;color:orange; ' class="nav-link   " class="nav-link   " href="visteurs.php?page=journal_vente_marchandise&id=<?=$donnees['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-book" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            </svg> Journal de  la facute de <?=$donnees['marchandise'] ?></a>
             <a style='font-size:1.1rem;; ' class="nav-link  text-danger " href="visteurs.php?page=supprimer_facture_vente_marchandise&id=<?=$donnees['id'] ?>&id_entreprise=<?=$_SESSION['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-x" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
<?php
      if ($stok_marchandise>0) {
       ...
       <a  class="nav-link   " style="font-size:1.1rem;"href="visteurs.php?page=stocks_marchandise&id=<?=$_SESSION['id'] ?>"> 
        ...
        Stocks Marchandises <span style='color:green'>( <?=$stok_marchandise - $vente_marchandise?> )</span> 
        </a><hr>
 ...
 <?php
    ...
    Stocks des Materiels <span style='color:green'> ( <?= $stok_materiel-$vente_materiels?>)</span>
    </a><hr>
     <?php
      }
  ?>
