...
<?php
   $bdd=new PDO('mysql:host=localhost; dbname=w&k;charset=utf8','root','');
   $select=$bdd->prepare('SELECT id_entreprise,nom_operation,montant_th, taux_tva,numero_banque,montant_payer,
...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbar">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item  mr-3">
              <a class="nav-link" href="visteurs.php?page=autres_charges">Journals<span class="sr-only">(current)</span></a>
            </li>
    ...
    <?php
     ...
     {
        $montant_ttc=$donnees['montant_th']*$donnees['taux_tva']/100+$donnees['montant_th'];
            $reste=$montant_ttc-$donnees['montant_payer'];
            $montant_tva=$donnees['montant_th']*$donnees['taux_tva']/100;
         ...
         ?>
          <div class="container ">
            <div class="row mt-4">
              ...
              Journal de <?= $donnees['nom_operation'] ?><br>
              date d'opération <?= $donnees['date'] ?>
                </div><hr>
                <div class="row ">
        ...
        <?php
          ...
          ?>
              ...
              <div class="row ">
                <div class="col-2  " style='border:solid black 1px'>6..</div>
                <div class="col-2 " style='border:solid black 1px'></div>
                <div class="col-4 " style='border:solid black 1px'>
                  <?=  $donnees['nom_operation'] ?>
                </div>
                <div class="col-2 " style='border:solid black 1px'>
               
                </div>
                <div class="col-2 " style='border:solid black 1px'>  <?= $donnees['montant_th'] ?> </div>
              </div>
              <div class="row ">
               ...
               ?>
                <div class="row ">
                <div class="col-2  " style='border:solid black 1px'></div>
                <div class="col-2 " style='border:solid black 1px'>511</div>
                <div class="col-4 " style='border:solid black 1px'>
                 Banque
                </div>
                <div class="col-2 " style='border:solid black 1px'>
                <?= $donnees['montant_payer'] ?>
                </div>
                <div class="col-2 " style='border:solid black 1px'>
                </div>
              </div>
                ...
                <?php
                      if ($reste<0) {
                        ...
                        <div class="row ">
                        <div class="col-2  " style='border:solid black 1px'></div>
                        <div class="col-2 " style='border:solid black 1px'>5111</div>
                        <div class="col-4 " style='border:solid black 1px'>
                         Montant à recuperer
                        </div>
                        <div class="col-2 " style='border:solid black 1px'>
                      ...
                      <?php
                          ...
                          ?>
                           <div class="row ">
                        <div class="col-2  " style='border:solid black 1px'>5119</div>
                        <div class="col-2 " style='border:solid black 1px'></div>
                        <div class="col-4 " style='border:solid black 1px'>
                         Reste à retourner
                        </div>
...
<?php
          ...
          ?>
                        <div class="row ">
                        <div class="col-2  " style='border:solid black 1px'></div>
                        <div class="col-2 " style='border:solid black 1px'>5191</div>
                        <div class="col-4 " style='border:solid black 1px'>
                         Montant à payer
                        </div>
                        <div class="col-2 " style='border:solid black 1px'>
               ...
               if ($donnees['taux_tva']>0) {
                  ?>
                  <div class="row ">
                <div class="col-2  " style='border:solid black 1px'>3445</div>
                <div class="col-2 " style='border:solid black 1px'></div>
                <div class="col-4" style='border:solid black 1px'>
                  TVA Récuperable
                </div>
