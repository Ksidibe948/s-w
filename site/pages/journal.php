...
<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
 ...
 Stocks
      ...
      if ($stok_marchandise>0) {
        ?> <span style='color:green'>(<?=$stok_marchandise- $vente_marchandise?> )</span> 
        </a><hr>
     <?php
      }else {
        echo '(0)';
  ...
  ?>
    ...
    Stocks des Materiels  <?php
      if ($stok_materiel>0) {
        ?> <span style='color:green'> ( <?= $stok_materiel- $vente_materiels?>)</span>
    </a><hr>
     <?php
      }else {
       echo  '(0)';
...
<a  class="nav-link pl-2 "  style="font-size:1.2rem;color:#A41FDE " href="visteurs.php?page=journal&id=<?=$_SESSION['id'] ?>"> 
 ...
 <div class="col-lg-9 ">         
   <div class="row ">
    <div class="col-6 mt-3 ">
        ...
        <a  class="nav-link text-secondary" href="visteurs.php?page=journal_achats&id=<?=$_SESSION['id'] ?>">
        <svg width="5em" height="5em" color='orange' viewBox="0 0 16 16" class="bi  bi-file-text" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" d="M4 0h8a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2zm0 1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H4z"/>
        <path fill-rule="evenodd" d="M4.5 10.5A.5.5 0 0 1 5 10h3a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5zm0-2A.5.5 0 0 1 5 8h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5zm0-2A.5.5 0 0 1 5 6h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5zm0-2A.5.5 0 0 1 5 4h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5z"/>
        </svg>
        <p style='  font-size:2rem'> Achats marchandises <br>
        </p><br>
    ...
    <div class="col-6 mt-3 ">
        <div class="card w-100 shadow-lg bg-light"  >
        <div class="card-title text-center pt-5">
        <a  class="nav-link  text-secondary " href="visteurs.php?page=journal_vente_marchandise&id=<?=$_SESSION['id'] ?>">
        <svg width="5em" color='green' height="5em" viewBox="0 0 16 16" class="bi bi-file-text" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" d="M4 0h8a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2zm0 1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H4z"/>
        <path fill-rule="evenodd" d="M4.5 10.5A.5.5 0 0 1 5 10h3a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5zm0-2A.5.5 0 0 1 5 8h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5zm0-2A.5.5 0 0 1 5 6h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5zm0-2A.5.5 0 0 1 5 4h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5z"/>
        </svg>
        <p style='  font-size:2rem'> Ventes Marchandises </p>
         <br>
          </a> 
        </div>
    </div>
    ...
    <div class="col-6 mt-3 ">
        <div class="card w-100 shadow-lg  bg-light"  >
        <div class="card-title text-center pt-5">
        <a  class="nav-link text-secondary " href="visteurs.php?page=journal_achat_immobilisation&id=<?=$_SESSION['id'] ?>">
        <svg width="5em" Color='blue' height="5em" viewBox="0 0 16 16" class="bi bi-file-text" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" d="M4 0h8a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2zm0 1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H4z"/>
        <path fill-rule="evenodd" d="M4.5 10.5A.5.5 0 0 1 5 10h3a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5zm0-2A.5.5 0 0 1 5 8h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5zm0-2A.5.5 0 0 1 5 6h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5zm0-2A.5.5 0 0 1 5 4h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5z"/>
        </svg>
        <p style='  font-size:2rem'>Achats materiels </p>
         <br>
        </a> 
        </div>
    </div>
    ...
    <div class="col-6 mt-3 ">
        <div class="card w-100 shadow-lg bg-light"  >  
        <div class="card-title text-center pt-5">
        <a  class="nav-link text-secondary "  href="visteurs.php?page=journal_facture_vente_materiel&id=<?=$_SESSION['id'] ?>">              
        <svg width="5em" color='pink' height="5em" viewBox="0 0 16 16" class="bi bi-file-text" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" d="M4 0h8a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2zm0 1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H4z"/>
        <path fill-rule="evenodd" d="M4.5 10.5A.5.5 0 0 1 5 10h3a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5zm0-2A.5.5 0 0 1 5 8h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5zm0-2A.5.5 0 0 1 5 6h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5zm0-2A.5.5 0 0 1 5 4h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5z"/>
        </svg>
        <p style='  font-size:2rem'>Ventes Materiels</p>
          <br>
        </a> 
        </div>
    </div>
    ...
    <div class="col-6 mt-3 ">
        <div class="card w-100 shadow-lg bg-light"  >  
        <div class="card-title text-center pt-5">
        <a  class="nav-link text-secondary "  href="visteurs.php?page=journal_autre_produits&id=<?=$_SESSION['id'] ?>">              
        <svg width="5em" height="5em" viewBox="0 0 16 16" class="bi bi-file-text" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" d="M4 0h8a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2zm0 1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H4z"/>
        <path fill-rule="evenodd" d="M4.5 10.5A.5.5 0 0 1 5 10h3a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5zm0-2A.5.5 0 0 1 5 8h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5zm0-2A.5.5 0 0 1 5 6h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5zm0-2A.5.5 0 0 1 5 4h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5z"/>
        </svg>
        <p style='  font-size:1.5rem'> Autres Produits</p>
        </a> 
        </div>
    </div>
    </div>
    <div class="col-6 mt-3 ">
        <div class="card w-100 shadow-lg bg-light"  >  
        <div class="card-title text-center pt-5">
        <a  class="nav-link text-secondary "  href="visteurs.php?page=journal_autre_charge&id=<?=$_SESSION['id'] ?>">              
        <svg width="5em" color='red' height="5em" viewBox="0 0 16 16" class="bi bi-file-text" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" d="M4 0h8a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2zm0 1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H4z"/>
        <path fill-rule="evenodd" d="M4.5 10.5A.5.5 0 0 1 5 10h3a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5zm0-2A.5.5 0 0 1 5 8h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5zm0-2A.5.5 0 0 1 5 6h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5zm0-2A.5.5 0 0 1 5 4h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5z"/>
        </svg>
        <p style='  font-size:2rem'>Autres Charges</p>
        </a> 
        </div>
    </div>
    </div>
