...
$bdd=new PDO('mysql:host=localhost; dbname=w&k;charset=utf8','root','');
  ...
  <a  class="nav-link " style="font-size:1.2rem; color:#A41FDE  " href="visteurs.php?page=actionnaires&id=<?=$_SESSION['id'] ?>">
  <?php
    ...
    <div class="col-lg-12 mt-3 ">
     ...
     <?php
        ...
        while($resultat=$select->fetch())
        {
            ?>
            <div class="col-lg-6">
            <a class="nav-link " href="visteurs.php?page=detail_actionnaire&id=<?=$resultat['id'] ?>">
