...
<a style="font-size:1.2rem; color:#A41FDE" class="nav-link pl-5" href="#">
  <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-credit-card-2-back" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M14 3H2a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1zM2 2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H2z"/>
  <path d="M11 5.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1-.5-.5v-1zM1 9h14v2H1V9z"/>
</svg>
 Détail  <?=$donness['nom_banque'] ?>
</a>
<a style='margin-left:15px ;' class="nav-link pl-5 text-success " href="visteurs.php?page=modifier_banque&id=<?=$donness['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M13.498.795l.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001zm-.644.766a.5.5 0 0 0-.707 0L1.95 11.756l-.764 3.057 3.057-.764L14.44 3.854a.5.5 0 0 0 0-.708l-1.585-1.585z"/>
  </svg> Modifier  <?=$donness['nom_banque'] ?></a>
  <a style='margin-left:15px;'class="nav-link pl-5 text-danger " href="visteurs.php?page=supprimer_banque&id=<?=$donness['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-x" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
 <path fill-rule="evenodd" d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
 </svg> Supprimer  <?=$donness['nom_banque'] ?> </a>
<a style='font-size:1.1rem' class="nav-link  text-info " href="visteurs.php?page=nouvelle_banque&id=<?=$_SESSION['id'] ?>">
...
<a  class="nav-link " style="font-size:1.2rem;" href="visteurs.php?page=Bilan&id=<?=$_SESSION['id'] ?>">
 ...
 CPC
    ...
    <div class="col-lg-12 mt-3 ">
        <div class="card  w-100 shadow-lg  white"  >
    ...
    <div class="col-lg-12 mt-3 ">
      <h5> <div class="row">
           <div style='border: solid black 1px; font-size:1.5rem' class="col-lg-12  p-2 text-center bg-info text-white " >
               <?=$donness['nom_banque'] ?>
           </div>
