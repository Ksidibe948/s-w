...
<div class="row">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    ...
    <a  class="nav-link active" style=' color:#A41FDE ;' href="visteurs.php?page=Stocks&id=<?=$_SESSION['id'] ?>"><i class="fas fa-chart-line"></i>  Stocks</a>
    </li>
    </ul>
  </div>
</nav>
...
<div class="col-lg-9 ">         
   <div class="row ">
        <div class="col-lg-4 ">
        <a class="nav-link " style='color:green;' href="visteurs.php?page=stocks_marchandise&id=<?=$_SESSION['id'] ?>">
         <div class="card w-100 shadow-lg p-3 bg-white "  >
          <div class="card-title text-center pt-2">
            <p style='  font-size:1.5rem'>Stocks de Marchandises</p>
            </div>
            <div class='imagess'>
         ...
         <div class="col-lg-4 ">
        <a class="nav-link " style='color:green;' href="visteurs.php?page=stock_matiere_premiere&id=<?=$_SESSION['id'] ?>">
         <div class="card w-100 shadow-lg p-3 bg-white "  >
          <div class="card-title text-center pt-2">
            <p style='  font-size:1.5rem'>Stocks de Matiere premiere</p>
            </div>
            <div class='imagess'>
            <img src="../site/images/stocks_marchandises.jpg" class="card-img" alt="">
            </div>
        ...
        <div class="col-lg-4 ">
        <a  class="nav-link " style='color:green;' href="visteurs.php?page=stocks_materiels&id=<?=$_SESSION['id'] ?>">
         <div class="card w-100 shadow-lg p-3 bg-white " >
         <div class="card-title text-center pt-2">
            <p style='  font-size:1.5rem'> Stocks de Materiels</p>
            </div>
            <div class='imagess'>
