...
<?php
   ...
   FROM achats_immobilisation,fournisseurs WHERE achats_immobilisation.id_client=fournisseurs.id AND achats_immobilisation.id_entreprise=? ORDER BY id DESC");
   $achat_imo->execute(array( $_SESSION['id']));
 ?>
        ...
        <div class="collapse navbar-collapse" id="navbar">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item  mr-3">
              <a class="nav-link" href="visteurs.php?page=journals">Journals<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item active  mr-3">
              <a class="nav-link" href=""> Journals des Achats de Materièls <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item mr-3">
    ...
    while($donnees=$achat_imo->fetch())
     {
      ...
      $net_commercial=$montant-$montant_reduction;
       ...
       $train='-';
         ?>
          <div class="container text-white"><a style='color:black;   text-decoration: none;' href="visteurs.php?page=journal_marteriel_acheter&id=<?=$donnees['id'] ?>">
            <div class="row mb-4">
              <div class="col-12">
                ...
                <div class="col-2 text-center " style='border:solid black 1px'>Débit</div>
                <div class="col-2 text-center" style='border:solid black 1px'>Crédit</div>
                <div class="col-4 text-center" style='border:solid black 1px'>
                  Libelle
                </div>
                <div class="col-2 text-center" style='border:solid black 1px'>
                  Montant D
                </div>
                <div class="col-2 text-center" style='border:solid black 1px'>Montant C</div>
              </div>
              
                    <div class="row ml-3 mr-3">
                      <div class="col-2 text-center " style='border:solid black 1px'>611</div>
                      <div class="col-2 text-center" style='border:solid black 1px'>-</div>
                      <div class="col-4 text-center" style='border:solid black 1px'>
                    ...
                    {?>
                    <div class="row ml-3 mr-3">
                    <div class="col-2 text-center " style='border:solid black 1px'>3455</div>
                    <div class="col-2 text-center" style='border:solid black 1px'>-</div>
                    <div class="col-4 text-center" style='border:solid black 1px'>
                      TVA Récupérable
                    </div>
                ...
                <div class="row ml-3 mr-3">
                  <div class="col-2 text-center " style='border:solid black 1px'>6142</div>
                  <div class="col-2 text-center" style='border:solid black 1px'>-</div>
                  <div class="col-4 text-center" style='border:solid black 1px'>
                    Transports
                  </div>
                  ...
                  <div class="col-2 text-center" style='border:solid black 1px'>-</div>
                    ...
                    {?>
                    <div class="row ml-3 mr-3 ">
                    <div class="col-2 text-center " style='border:solid black 1px'>3413</div>
                    <div class="col-2 text-center" style='border:solid black 1px'>-</div>
                    <div class="col-4 text-center" style='border:solid black 1px'>
                      Emballage
                    </div>
                    ...
                    <div class="row ml-3 mr-3 ">
                      <div class="col-2 text-center " style='border:solid black 1px'>-</div>
                      <div class="col-2 text-center" style='border:solid black 1px'>4411</div>
                      <div class="col-4 text-center" style='border:solid black 1px'>
                        Fournisseur
                      </div>
                      <div class="col-2 text-center" style='border:solid black 1px'>
                    ...
                    <div class="row ml-3 mr-3 ">
                    <div class="col-2 text-center " style='border:solid black 1px'>-</div>
                    <div class="col-2 text-center" style='border:solid black 1px'>7386</div>
                    <div class="col-4 text-center" style='border:solid black 1px'>
                      Exompte
                    </div>
                    <div class="col-2 text-center" style='border:solid black 1px'>
                  ...
                  <div class="row ml-3 mr-3 ">
                  <div class="col-2 text-center " style='border:solid black 1px'>-</div>
                  <div class="col-2 text-center" style='border:solid black 1px'>2397</div>
                  <div class="col-4 text-center" style='border:solid black 1px'>
              ...
              <div class="row ml-3 mr-3 ">
                <div class="col-8 text-center " style='border:solid black 1px'>
                  Totaux
                </div>
                <div class="col-2 text-center" style='border:solid black 1px'>
                <?= $totaldebit ?>
              ...
              <?php if ($reste<0)
                ...
                <div class="row ml-3 mr-3">
                  <div class="col-2 text-center " style='border:solid black 1px'><?=$banque?></div>
                  <div class="col-2 text-center" style='border:solid black 1px'>-</div>
                  <div class="col-4 text-center" style='border:solid black 1px'>
                  <?= $reste_a_recupere ?> 
                  </div>
                  ...
                  <div class="col-2 text-center" style='border:solid black 1px'> <?= $reste ?> </div>
                </div>
                  <?php
                  } 
                  ?>
        ...
        <?php
          ...
          ?>
                ...
                <div class="col-2 text-center" style='border:solid black 1px'><?= $donnees['montant_payement'] ?></div>
              </div>
                <?php
            ...
            <?php
                    ...
                    <div class="row  ml-3 mr-3">
                    <div class="col-2 text-center " style='border:solid black 1px'>-</div>
                    <div class="col-2 text-center" style='border:solid black 1px'><?= $code_credit?></div>
                    <div class="col-4 text-center" style='border:solid black 1px'>
                    <?= $credit?>
                    </div>
                    <div class="col-2 text-center" style='border:solid black 1px'>-
