...
<div class="row">
 ...
 Ajouter un nouveau produit nouveauproduit_financier
</a>
 </a>
...
<div class="card shadow-lg p-4 mr-5 w-100">
   <div class="row ">
          <div class="col-12 pt-2 text-center  bg-info"style='border:solid 0.5px gray'>
          <a  class="nav-link   text-white"  href="visteurs.php?page=nouveauproduit_financier&id=<?=$_SESSION['id'] ?>">
          <h1>AJOUTER UN NOUVEAU PRODUIT FINANCIER</h1>
          </a>
        </div>
          </div> 
   <div class="card shadow-lg p-4 mr-5 w-100">
