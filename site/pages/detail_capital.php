...
<?php
  ...
  <a href="#" class="nav-link  "   style="font-size:1.2rem; color:#A41FDE">
    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-cash-stack" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      <path d="M14 3H1a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1h-1z"/>
      <path fill-rule="evenodd" d="M15 5H1v8h14V5zM1 4a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1H1z"/>
      <path d="M13 5a2 2 0 0 0 2 2V5h-2zM3 5a2 2 0 0 1-2 2V5h2zm10 8a2 2 0 0 1 2-2v2h-2zM3 13a2 2 0 0 0-2-2v2h2zm7-4a2 2 0 1 1-4 0 2 2 0 0 1 4 0z"/>
    ...
    <a  class="nav-link  text-success "  style='margin-left:15px ;' href="visteurs.php?page=modifier_capital&id=<?=$resultat['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
     <path fill-rule="evenodd" d="M13.498.795l.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001zm-.644.766a.5.5 0 0 0-.707 0L1.95 11.756l-.764 3.057 3.057-.764L14.44 3.854a.5.5 0 0 0 0-.708l-1.585-1.585z"/>
     </svg> Modifier ce capital </a>
     <a  class="nav-link  text-danger" style='margin-left:15px; ' href="visteurs.php?page=supprimer_capital&id=<?=$resultat['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-x" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path fill-rule="evenodd" d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
    </svg> Supprimer ce capital </a>
  <a style='font-size:1.1rem'class="nav-link  text-info  " href="visteurs.php?page=nouveau_capital&id=<?=$_SESSION['id'] ?>">
    <svg width="1.1em" height="1.1em" viewBox="0 0 16 16" class="bi bi-plus" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      <path fill-rule="evenodd" d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
    </svg>
       Créer un nouveau capital 
    </a>
  <hr>
 ...
 <div class="container">
    <div class="col-lg-9">
    <div class="row mt-4"style='border: solid white 1px'>
     <?php
      ...
      
        {
          $prix_action=$resultat['capital']/$resultat['actions'];
            ...
            <div class="card shadow-lg p-4" >
                <div class="row " >
                  <div class="col-6 p-3 text-center bg-info text-white" >
                    Elements
                  </div>
                  <div class="col-6 p-3 text-center bg-info text-white" style='border: solid white 1px'>
                    Montants
                  </div>
                  <div class="col-6 p-3 " style='border: solid gray 1px'>
                    Numéro d'émission
                  </div>
                  <div class="col-6 p-3 text-right" style='border: solid gray 1px'>
                  <em> <?=$resultat['id'] ?></em>
                  </div>
                  <div class="col-6 p-3 " style='border: solid gray 1px'>
                    Date d'émission
