...
<div class="row">
 ...
 <a  class="nav-link pl-2 "  style="font-size:1.2rem;" href="visteurs.php?page=produits_exploitation&id=<?=$_SESSION['id'] ?>"> 
  <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-fullscreen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M1.5 1a.5.5 0 0 0-.5.5v4a.5.5 0 0 1-1 0v-4A1.5 1.5 0 0 1 1.5 0h4a.5.5 0 0 1 0 1h-4zM10 .5a.5.5 0 0 1 .5-.5h4A1.5 1.5 0 0 1 16 1.5v4a.5.5 0 0 1-1 0v-4a.5.5 0 0 0-.5-.5h-4a.5.5 0 0 1-.5-.5zM.5 10a.5.5 0 0 1 .5.5v4a.5.5 0 0 0 .5.5h4a.5.5 0 0 1 0 1h-4A1.5 1.5 0 0 1 0 14.5v-4a.5.5 0 0 1 .5-.5zm15 0a.5.5 0 0 1 .5.5v4a1.5 1.5 0 0 1-1.5 1.5h-4a.5.5 0 0 1 0-1h4a.5.5 0 0 0 .5-.5v-4a.5.5 0 0 1 .5-.5z"/>
</svg>
 Produits Exploitations
 </a>
 <a  class="nav-link pl-2 "  style="font-size:1.2rem;" href="visteurs.php?page=produits_financiers&id=<?=$_SESSION['id'] ?>"> 
  <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-fullscreen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M1.5 1a.5.5 0 0 0-.5.5v4a.5.5 0 0 1-1 0v-4A1.5 1.5 0 0 1 1.5 0h4a.5.5 0 0 1 0 1h-4zM10 .5a.5.5 0 0 1 .5-.5h4A1.5 1.5 0 0 1 16 1.5v4a.5.5 0 0 1-1 0v-4a.5.5 0 0 0-.5-.5h-4a.5.5 0 0 1-.5-.5zM.5 10a.5.5 0 0 1 .5.5v4a.5.5 0 0 0 .5.5h4a.5.5 0 0 1 0 1h-4A1.5 1.5 0 0 1 0 14.5v-4a.5.5 0 0 1 .5-.5zm15 0a.5.5 0 0 1 .5.5v4a1.5 1.5 0 0 1-1.5 1.5h-4a.5.5 0 0 1 0-1h4a.5.5 0 0 0 .5-.5v-4a.5.5 0 0 1 .5-.5z"/>
</svg>
 Produits Financier
 </a>
 <a  class="nav-link pl-2 "  style="font-size:1.2rem; color:#A41FDE" href="visteurs.php?page=produits_execeptionnels&id=<?=$_SESSION['id'] ?>"> 
  <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-fullscreen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M1.5 1a.5.5 0 0 0-.5.5v4a.5.5 0 0 1-1 0v-4A1.5 1.5 0 0 1 1.5 0h4a.5.5 0 0 1 0 1h-4zM10 .5a.5.5 0 0 1 .5-.5h4A1.5 1.5 0 0 1 16 1.5v4a.5.5 0 0 1-1 0v-4a.5.5 0 0 0-.5-.5h-4a.5.5 0 0 1-.5-.5zM.5 10a.5.5 0 0 1 .5.5v4a.5.5 0 0 0 .5.5h4a.5.5 0 0 1 0 1h-4A1.5 1.5 0 0 1 0 14.5v-4a.5.5 0 0 1 .5-.5zm15 0a.5.5 0 0 1 .5.5v4a1.5 1.5 0 0 1-1.5 1.5h-4a.5.5 0 0 1 0-1h4a.5.5 0 0 0 .5-.5v-4a.5.5 0 0 1 .5-.5z"/>
</svg>
 Produits exceptionnels
 <a style="font-size:1.2rem;" class="nav-link  text-success" href="visteurs.php?page=modifier_produitexceptionnel&id=<?=$resultat['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
 ...
 CPC
     ...
     <div class="container">
         ...
         <div class="row">
                            ...
                            <div class="col-lg-12">
                            <div class="card shadow-lg mt-5 bg-light  text-info w-100" style="width: 18rem; ">
                            <div class="card-body">
                                <hr><h1 class="card-title bg-success text-white p-2 text-center">
                              ...
                              <label for="inputPassword" class="col-lg-12 col-form-label pl-5"><h5>Nom de l'operation</h5></label>
                              <div class="col-lg-12">
                            ...
                            <div class="form-group row">
                              <div class="col-lg-12"></div>
                              <label for="inputPassword" class="col-lg-12 col-form-label pl-5"><h5>Montant_th  HT</h5></label>
                              <div class="col-lg-12">
                            ...
                            <div class="form-group row">
                              <div class="col-lg-12"></div>
                              <label for="inputPassword" class="col-lg-12 col-form-label pl-5"><h5>TVA </h5></label>
                              <div class="col-lg-12">
                            ...
                            <div class="form-group row">
                              <div class="col-lg-12"></div>
                              <label for="inputPassword" class="col-lg-12 col-form-label pl-5"><h5> Bancaire</h5></label>
                              <div class="col-lg-12">
                            ...
                            <div class="form-group row">
                              <div class="col-lg-12"></div>
                              <label for="inputPassword" class="col-lg-12 col-form-label pl-5"><h5>Montant payer</h5></label>
                              <div class="col-lg-12">
