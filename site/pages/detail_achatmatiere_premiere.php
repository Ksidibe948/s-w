...
<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  Detail de la facture de <span style='color:green'> ( <?=$donnees['marchandise'] ?> )</span>
  </a>
  <a style="font-size:1.2rem;" class="nav-link  text-success" href="visteurs.php?page=modifierfactureachatmatierepremiere&id=<?=$_GET['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <a  style="font-size:1.2rem;" class="nav-link  text-danger" href="visteurs.php?page=supprimer_achatmatiere_premiere&id=<?=$_GET['id'] ?>"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-x" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
 <path fill-rule="evenodd" d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
 </svg> Supprimer la facture de <?=$donnees['marchandise'] ?> </a> 
  <a style='font-size:1.2rem' class="nav-link  text-info "  href="visteurs.php?page=nouvelle_facture_achat&id=<?=$_SESSION['id'] ?>">
  <svg width="1.1em" height="1.1em" viewBox="0 0 16 16" class="bi bi-plus" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path fill-rule="evenodd" d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
  </svg>
     Ajouter une nouvelle facture achat matiere première
  </a>
  <hr>
