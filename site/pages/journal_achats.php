    ...
    <?php
     ...
     while($donnees=$achats->fetch())
     {
      ...
      $net_commercial=$montant-$montant_reduction;
       ...
       $code_credit=3482;
       $reste_a_recupere='Reste à récupérer';
       $tout_a_payer='Rien payer';
       $train='-';
         ?>
          <div class="container text-white"><a style='color:black;   text-decoration: none;' href="visteurs.php?page=journal_marchandise_acheter&id=<?=$donnees['id'] ?>">
            <div class="row mb-4">
              <div class="col-12">
                <div class="card shadow-lg pl-4 ml-2 pr-4 w-100">
                  <div class="row">
                <hr> <div class="col-12 text-center mt-2 ">
                   <h5>Facture N° <?= $donnees['id'] ?></h5>
                   <?= $donnees['date'] ?><br>
                 </div>
                  </div>
                 <div class="row  ">
                <div class="col-2  " style='border:solid gray 1px'>Débit</div>
                <div class="col-2 " style='border:solid gray 1px'>Crédit</div>
                <div class="col-4 " style='border:solid gray 1px'>
                  Libelle
                </div>
                <div class="col-2 " style='border:solid gray 1px'>
                  Montant D
                </div>
                <div class="col-2 " style='border:solid gray 1px'>Montant C</div>
              </div>
              
                    <div class="row ">
                      <div class="col-2  " style='border:solid gray 1px'>611</div>
                      <div class="col-2 " style='border:solid gray 1px'>-</div>
                      <div class="col-4 " style='border:solid gray 1px'>
                        Achat revendu de <strong><?= $donnees['marchandise'] ?></strong>
                      </div>
                      <div class="col-2 " style='border:solid gray 1px;'>
                        <?= $net_commercial ?>
                      </div>
                    ...
                    {?>
                    <div class="row ">
                    <div class="col-2  " style='border:solid gray 1px'>3455</div>
                    <div class="col-2 " style='border:solid gray 1px'>-</div>
                    <div class="col-4 " style='border:solid gray 1px'>
                      TVA Récupérable
                    </div>
                ...
                <div class="row ">
                  <div class="col-2  " style='border:solid gray 1px'>6142</div>
                  <div class="col-2 " style='border:solid gray 1px'>-</div>
                  <div class="col-4 " style='border:solid gray 1px'>
                    Transports
                  </div>
                  <div class="col-2 " style='border:solid gray 1px'>
                    <?= $donnees['montant_transport'] ?>
                  </div>
                  <div class="col-2 " style='border:solid gray 1px'>-</div>
                </div>
                    <?php
                    ...
                    {?>
                    <div class="row  ">
                    <div class="col-2  " style='border:solid gray 1px'>3413</div>
                    <div class="col-2 " style='border:solid gray 1px'>-</div>
                    <div class="col-4 " style='border:solid gray 1px'>
                      Emballage
                    </div>
                    <div class="col-2 " style='border:solid gray 1px'>
                      <?= $donnees['montant_emballage'] ?>
                    </div>
                    <div class="col-2 " style='border:solid gray 1px'>-</div>
                  </div>
                    <?php
                    ...
                    <div class="row  ">
                      <div class="col-2  " style='border:solid gray 1px'>-</div>
                      <div class="col-2 " style='border:solid gray 1px'>4411</div>
                      <div class="col-4 " style='border:solid gray 1px'>
                        Fournisseur
                      </div>
                      <div class="col-2 " style='border:solid gray 1px'>
                    ...
                    <div class="row  ">
                    <div class="col-2  " style='border:solid gray 1px'>-</div>
                    <div class="col-2 " style='border:solid gray 1px'>7386</div>
                    <div class="col-4 " style='border:solid gray 1px'>
                      Exompte
                    </div>
                    <div class="col-2 " style='border:solid gray 1px'>
                  ...
                  <div class="row  ">
                  <div class="col-2  " style='border:solid gray 1px'>-</div>
                  <div class="col-2 " style='border:solid gray 1px'>2397</div>
                  <div class="col-4 " style='border:solid gray 1px'>
              ...
              <div class="row  ">
                <div class="col-8  " style='border:solid gray 1px'>
                  Totaux
                </div>
                <div class="col-2 " style='border:solid gray 1px'>
                <?= $totaldebit ?>
              ...
              <?php if ($reste<0)
                ...
                <div class="row ">
                  <div class="col-2  " style='border:solid gray 1px'><?=$banque?></div>
                  <div class="col-2 " style='border:solid gray 1px'>-</div>
                  <div class="col-4 " style='border:solid gray 1px'>
                  <?= $reste_a_recupere ?> 
                  </div>
                  ...
                  <div class="col-2 " style='border:solid gray 1px'><?= $reste ?> </div>
                </div>
                  <?php
                  } 
                  ?>
        ...
        <?php
          ...
          ?>
                ...
                <div class="col-2 " style='border:solid gray 1px'><?= $donnees['montant_payement'] ?></div>
              </div>
                <?php
            ...
            <?php
                    ...
                    <div class="row  ">
                    <div class="col-2  " style='border:solid gray 1px'>-</div>
                    <div class="col-2 " style='border:solid gray 1px'><?= $code_credit?></div>
                    <div class="col-4 " style='border:solid gray 1px'>
                    <?= $credit?>
                    </div>
                    <div class="col-2 " style='border:solid gray 1px'>-
