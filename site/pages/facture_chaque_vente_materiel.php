...
<?php
   ...
   $factures=$bdd->prepare('SELECT * FROM  vente_materiels WHERE id=?');
...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbar">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active  mr-3">
              <a class="nav-link" href="">factures vente Materièls<span class="sr-only">(current)</span></a>
            </li>
    ...
    <div class="jumbotron jumbotron-fluid">
      ...
      <h1 class="display-4">La facture de vente_materiels  <?= $facture['marchandise'] ?> </h1>
      <?= $djate?>
