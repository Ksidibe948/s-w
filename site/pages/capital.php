...
<?php
  ...
  <hr>
  <a   class="nav-link  " style="font-size:1.2rem; color:#A41FDE" href="visteurs.php?page=capital&id=<?=$_SESSION['id'] ?>">
     ...
     <?php
      ...
      
        {
          $prix_action=$resultat['capital']/$resultat['actions'];
            ...
            <a style='font-size:1.1rem' class="nav-link text-info " href="visteurs.php?page=detail_capital&id=<?=$resultat['id'] ?>">
                <div class="row " >
